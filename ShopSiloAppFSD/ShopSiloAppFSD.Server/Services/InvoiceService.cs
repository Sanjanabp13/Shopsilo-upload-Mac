    ...
    public class InvoiceService
    {
        ...
        public async Task<byte[]> GenerateInvoicePdfAsync(int orderId)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                // Add company logo
                var logoPath = "/Users/sanjanabiminiprakashbabu/Desktop/hexawarefolder/Hexaware-201 csharp codes/ShopSiloApp-main/ShopSiloAppFSD/shopsiloappfsd.client/public/images/shopSiloLogo.png";
