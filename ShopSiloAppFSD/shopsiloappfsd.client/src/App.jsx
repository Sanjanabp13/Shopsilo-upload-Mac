...
import EditProductFormAdmin from './components/Admin/ProductDetails/EditProductFormAdmin.jsx';
    ...
    return (
        <Routes>
            ...
            <Route path="/admin" element={<AdminLayout />} >
                ...
                <Route path="editproduct/:productId" element={<EditProductFormAdmin />} /> 
            </Route>
